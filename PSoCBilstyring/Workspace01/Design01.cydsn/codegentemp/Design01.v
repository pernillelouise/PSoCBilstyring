...
module ADC_SAR_SEQ_P4_v2_30_1 (
	...
	cy_clock_v1_0
		#(.id("c0d2ab83-b27d-4723-8229-1f3f3482ed90/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PWM_v3_30, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_venstre, CY_INSTANCE_SHORT_NAME=PWM_venstre, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=PWM_venstre, )
module PWM_v3_30_2 (
    pwm2,
    tc,
    clock,
...
module top ;
    ...
    PWM_v3_30_0 PWM_hojre (
        ...
        .ph1(Net_174),
        .ph2(Net_175));
    defparam PWM_hojre.Resolution = 8;


	cy_clock_v1_0
		#(.id("6036b93d-d71e-43eb-a408-c72e11192529"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__PWM_RIGHT_net;
	wire [0:0] tmpFB_0__PWM_RIGHT_net;
	wire [0:0] tmpIO_0__PWM_RIGHT_net;
	wire [0:0] tmpINTERRUPT_0__PWM_RIGHT_net;
	electrical [0:0] tmpSIOVREF__PWM_RIGHT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_RIGHT
		 (.oe(tmpOE__PWM_RIGHT_net),
		  .y({Net_113}),
		  .fb({tmpFB_0__PWM_RIGHT_net[0:0]}),
		  .io({tmpIO_0__PWM_RIGHT_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_RIGHT_net),
		  .interrupt({tmpINTERRUPT_0__PWM_RIGHT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_RIGHT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__speedPin_net;
	wire [0:0] tmpFB_0__speedPin_net;
	wire [0:0] tmpIO_0__speedPin_net;
	wire [0:0] tmpINTERRUPT_0__speedPin_net;
	electrical [0:0] tmpSIOVREF__speedPin_net;

	cy_psoc3_pins_v1_10
		#(.id("ec5b7916-98cf-4487-ae6d-83ec807ba25a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		speedPin
		 (.oe(tmpOE__speedPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__speedPin_net[0:0]}),
		  .analog({Net_437}),
		  .io({tmpIO_0__speedPin_net[0:0]}),
		  .siovref(tmpSIOVREF__speedPin_net),
		  .interrupt({tmpINTERRUPT_0__speedPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__speedPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_2 PWM_venstre (
        .reset(1'b0),
        .clock(Net_60),
        .tc(Net_421),
        .pwm1(Net_422),
        ...
        .ph1(Net_430),
        .ph2(Net_431));
    defparam PWM_venstre.Resolution = 8;

	wire [0:0] tmpOE__PWM_left_net;
	wire [0:0] tmpFB_0__PWM_left_net;
	wire [0:0] tmpIO_0__PWM_left_net;
	wire [0:0] tmpINTERRUPT_0__PWM_left_net;
	electrical [0:0] tmpSIOVREF__PWM_left_net;

	cy_psoc3_pins_v1_10
		#(.id("bdb0ba2e-a504-4bfb-b821-1022f511f03e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_left
		 (.oe(tmpOE__PWM_left_net),
		  .y({Net_358}),
		  .fb({tmpFB_0__PWM_left_net[0:0]}),
		  .io({tmpIO_0__PWM_left_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_left_net),
		  .interrupt({tmpINTERRUPT_0__PWM_left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("204c9618-a388-4cec-9c13-0625e5ca0020"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f3c89707-9fec-4dd0-b9b8-8d2c82dc4a30"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("50466dd1-56a3-4cc0-a958-b129f2481495"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("dd54c1a3-5c03-4fa1-907b-f4517c1f14c2"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
    ...
    SCB_P4_v3_10_4 UART_print (
        .interrupt(Net_590),
        .clock(1'b0),
        .rx_tr_out(Net_592),
        .tx_tr_out(Net_593));

    SCB_P4_v3_10_5 I2C_1 (
        .interrupt(Net_594),
        .clock(1'b0),
        .rx_tr_out(Net_596),
        .tx_tr_out(Net_597));
